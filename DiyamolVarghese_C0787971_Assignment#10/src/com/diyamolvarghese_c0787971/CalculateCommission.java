...
public class CalculateCommission {
    protected static double[] rate = {5, 10, 12, 15, 16};
    ...
    public static double CalculatePay(double advance, double commissionAmount,boolean balance) {
        double pay = 0;
        pay = advance-commissionAmount;
        return pay;
    }
}
